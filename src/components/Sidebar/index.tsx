        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === `/${locale}/dashboard/about` || pathname.includes("about")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                         href={`/${locale}/dashboard/about`}
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === `/${locale}/dashboard/about` ||
             ...
             <RiArticleLine/>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                                href={`/${locale}/dashboard/about/offices`}
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `/${locale}/dashboard/about/offices` &&
                                "text-white"
                              }`}
                            >
                             Offices
                          ...
                          <li>
                            <Link
                                href={`/${locale}/dashboard/about/firmProfile`}
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `/${locale}/dashboard/about/firmProfile` &&
                                "text-white"
                              }`}
                            >
                            Firm Profile
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === `/${locale}/dashboard/blogs` || pathname.includes("blogs")
                }
              >
                {(handleClick, open) => {
                  return (
       ...
       href={`/${locale}/dashboard/clients`}
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("email") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
             ...
             <RiArticleLine/>
                      ...
                      >
                        ...
                        <li>
                            <Link
                                href={`/${locale}/dashboard/blogs`}
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `/${locale}/dashboard/blogs` &&
                                "text-white"
                              }`}
                            >
                             Blogs
                          ...
                          <li>
                            <Link
                                href={`/${locale}/dashboard/blogs/authors`}
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `/${locale}/dashboard/blogs/authors` &&
                                "text-white"
                              }`}
                            >
                             Authors
              ...
              <li>
                <Link
                   href={`/${locale}/dashboard/subscribers`}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              <li>
                <Link
                   href={`/${locale}/dashboard/references`}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("references") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  ...
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname ===  `/${locale}/dashboard/forms` ||
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                            href={`/${locale}/dashboard/forms/form-elements`}
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          ...
                          <li>
                            <Link
                       href={`/${locale}/dashboard/forms/form-layout`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `/${locale}/dashboard/forms/form-layout` &&
                                "text-white"
                              }`}
                            >
                              Form Layout
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                             href={`/${locale}/dashboard/ui/alerts`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          ...
                          <li>
                            <Link
                             href={`/${locale}/dashboard/ui/buttons`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                          href={`/${locale}/dashboard/auth/signin`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          ...
                          <li>
                            <Link
                               href={`/${locale}/dashboard/auth/signup`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
