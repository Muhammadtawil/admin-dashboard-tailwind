...
const FirmProfileComponent = () => {
    const { data: session } = useSession();
    const t = useTranslations('webAboutUs');
    const tr=useTranslations('webChooseUs')
  return (
    <>
      <Breadcrumb pageName="FIRM Profile" />
        ...
        <div className="relative z-20 h-1/4 md:h-65 bg-cover">
          <Image
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <Image
              className="rounded-full items-center justify-center pt-10"
                src={'/mainLogoDev.png'}
                width={160}
                height={160}
                alt="profile"
              ...
              <label
                htmlFor="profile"
                className="absolute top-0 right-1 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
              >
                <svg
                  className="fill-current"
                  width="14"
          ...
          <div className="mt-4">
           ...
           {'LawFirm'}
            ...
            <p className="font-medium">for legal services</p>
      ...
      {t('description')}
            ...
            <RiInstagramFill className='text-xl hover:text-danger'/>
                <FaPhone className=' hover:text-success'/>
                <MdMail className='text-xl hover:text-primary'/>
              </div>
            </div>
            <div className="mx-auto max-w-180 pt-9">
              <h4 className="font-semibold text-black dark:text-white">
              {tr('title')}
              </h4>
              <p className="mt-4.5">
...
export default FirmProfileComponent;
