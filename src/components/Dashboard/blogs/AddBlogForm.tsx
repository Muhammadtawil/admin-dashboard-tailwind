...
export default function BlogAddComponent({ onCreate, onUpdate, isEdit, editedValues, UpdateImage }: { onCreate: any, onUpdate: any, isEdit: boolean, editedValues: any, UpdateImage: any }) {
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (e.target.files?.length === 0 && isEdit) {
      setNewImage(true)
      // setSelectedImage(editedValues.image);
  ...
  useEffect(() => {
    // Your code that depends on selectedImage
  }, [selectedImage]);
  ...
  return (
          ...
          <Grid container alignItems="center" spacing={2}>
            <Grid item xs={12} md={12} lg={12}>
              ...
              <TextField
                ...
                name="blogTitle"
                value={isEdit ? editedValues.blogTitle : null}
                required
                fullWidth
                id="Blog title"
                // label={t('blogTitle')}
    ...
    dangerouslySetInnerHTML={createMarkup(convertedContent)}>
            ...
            <Grid item xs={12} md={12} lg={6} className="dark:bg-strokedark dark:text-white">
              ...
              <TextField
                value={isEdit ? editedValues.author.authorName : null}
              ...
              <div >
                ...
                <div className="relative z-20 bg-white dark:bg-strokedark ">
                  ...
                  <select
                    ...
                    value={(isEdit && language == '') ? editedValues.blogLang : language}
                    name="blogLang"
