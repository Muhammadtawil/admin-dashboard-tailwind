...
export default function LoginFormTest() {
    ...
    return (
        <>
            ...
            <div className=" rounded-sm border border-stroke max-sm:border-none shadow-default dark:border-strokedark bg-boxdark ">
                <div className="flex flex-wrap items-center">
                    ...
                    <div className="w-full  border-bodydark2 xl:w-1/2 xl:border-l-2 bg-boxdark">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                         
                                <Image
                                    className="items-center text-center  max-sm:flex  max-sm:items-center"
                                    src={"/mainLogoDev.png"}
                                    alt="Logo"
                                    width={176}
                                    height={32}
                            ...
                            <h2 className="mb-9 text-2xl font-bold text-white sm:text-title-xl2 max-sm:flex max-sm:justify-center">
                                Sign In to Your Law Firm
                            </h2>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="relative"> 
                                        <input
                                            ...
                                            className="text-white w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                        />
